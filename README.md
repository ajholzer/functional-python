# Functional Python [![](https://github.com/ajholzer/functional-python/workflows/tests/badge.svg)](https://github.com/ajholzer/functional-python/actions?query=workflow%3Atests)
